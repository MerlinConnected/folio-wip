		...
		<section className='project-details'>
			...
			<div className='title-container'>
				<div className='content'>
					<h1 ref={titleRef}>{projects[6].title1 + ' ' + projects[6].title2}</h1>
					<div ref={detailRef} className='details'>
						...
						<div>
							...
							<p>{projects[6].client}</p>
						</div>
						<div>
							<p>
								<strong>Made w/</strong>
							</p>
							<p>{projects[6].softs}</p>
						</div>
						<div>
							<p>
								<strong>Roles</strong>
							</p>
							<p>{projects[6].roles}</p>
						</div>
					</div>
					{projects[6].websiteURL ? (
						<Link
							ref={hideRef}
							href={projects[6].websiteURL}
							target='_blank'
