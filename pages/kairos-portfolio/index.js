		...
		<section className='project-details'>
			...
			<div className='title-container'>
				<div className='content'>
					<h1 ref={titleRef}>{projects[4].title1 + ' ' + projects[4].title2}</h1>
					<div ref={detailRef} className='details'>
						...
						<div>
							...
							<p>{projects[4].client}</p>
						</div>
						<div>
							<p>
								<strong>Made w/</strong>
							</p>
							<p>{projects[4].softs}</p>
						</div>
						<div>
							<p>
								<strong>Roles</strong>
							</p>
							<p>{projects[4].roles}</p>
						</div>
					</div>
					{projects[4].websiteURL ? (
						<Link
							ref={hideRef}
							href={projects[4].websiteURL}
							target='_blank'
