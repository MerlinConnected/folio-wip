		...
		<Suspense fallback={null}>
			...
			<main>
				<header>
					...
					<nav>
						<a href='../public/Book-Jestin-2023-Majic.pdf' className='socials' target='_blank' rel='noopener noreferrer'>
				...
				<div class='description-container'>
					<p>
						<span class='serif-text'>hello</span> i'm <span class='serif-text'>Gaëtan Jestin.</span> <em>Today</em>, I'm a 3D
						<span class='serif-text'> Artist Based In</span> <em>Bordeaux.</em>
					</p>
					<p class='bottom-margin'>
						<em>Tomorrow</em> I'll be a <span class='serif-text'>creative developer. </span>I want to <span class='serif-text'>mix</span> both and create <em>awesome things.</em>
						<span class='serif-text'> Hopefully</span> working <em>w/ you</em> in a near future.
					</p>
				</div>
				<div class='footer'>
					<a href='https://www.linkedin.com/in/gaetan-jestin/' className='socials' target='_blank' rel='noopener noreferrer'>
