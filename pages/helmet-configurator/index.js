	...
	return (
		<section className='project-details'>
			<div className='image-container'>
				<img ref={imgRef} src='/images/helmet-configurator.jpeg' alt='Helmet Configurator' />
				<div ref={overlayRef}></div>
			</div>
			<div className='title-container'>
				<div className='content'>
					<h1 ref={titleRef}>{projects[1].title1 + ' ' + projects[1].title2}</h1>
					<div ref={detailRef} className='details'>
						...
						<div>
							...
							<p>{projects[1].client}</p>
						</div>
						<div>
							<p>
								<strong>Made w/</strong>
							</p>
							<p>{projects[1].softs}</p>
						</div>
						<div>
							<p>
								<strong>Roles</strong>
							</p>
							<p>{projects[1].roles}</p>
						</div>
					</div>
					{projects[1].websiteURL ? (
						<Link
							ref={hideRef}
							href={projects[1].websiteURL}
							target='_blank'
